  ...
  return (
    <div>
      <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
        ...
        <img
          className="w-full h-64 rounded-lg p-3"
            src={image}
            alt=""
          />
          <div>
        ...
        <div className="p-6">
          ...
          <h2 className="block font-sans text-xl antialiased font-medium leading-snug tracking-normal text-blue-gray-900">{name}</h2>
          <p className="font-Ubuntuu text-lg">Price: {price}</p>
          </div>
