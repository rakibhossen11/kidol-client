      ...
      <section className="bg-[#F2F3F4] px-[40px] pt-[100px] pb-[70px]">
        ...
        <div className="grid grid-cols-4 py-[40px]">
          ...
          <div>
            ...
            <p className="font-Nunito text-[16px] text-[#A6ACAF]">Car Available</p>
          </div>
          </div>
          <div className="flex gap-[14px] items-center">
          ...
          <div>
            ...
            <p className="font-Nunito text-[16px] text-[#A6ACAF]">Used Cars</p>
          </div>
          </div>
          <div className="flex gap-[14px] items-center">
          ...
          <div>
            ...
            <p className="font-Nunito text-[16px] text-[#A6ACAF]">Customer Satisfaction</p>
          </div>
          </div>
        </div>
